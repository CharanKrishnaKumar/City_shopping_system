                ...
                <tbody>
                    <?php while ($event = $events->fetch_assoc()): ?>
                        <tr>
                            <td>
                                <?php 
                                    $imagePath = !empty($event["image"]) && file_exists("uploads/" . $event["image"]) 
                                        ? "uploads/" . $event["image"] 
                                        : "assets/no-image.png"; 
                                ?>
                            ...
                            <td>£<?= number_format($event["offer_price"], 2); ?></td>
                            <td class="actions">
                                <a href="update_event.php?id=<?= $event["id"]; ?>" class="btn-edit">Edit</a>
